...
#include "openvslam/Thirdparty/g2o/g2o/core/base_vertex.h"
#include "openvslam/Thirdparty/g2o/g2o/core/base_unary_edge.h"
#include "so3.h"
#include "NavState.h"
#include "IMUPreintegrator.h"
#include "openvslam/Thirdparty/g2o/g2o/core/base_multi_edge.h"
#include "openvslam/Thirdparty/g2o/g2o/core/base_binary_edge.h"
#include "openvslam/Thirdparty/g2o/g2o/types/types_six_dof_expmap.h"
...
#else
class VertexNavStateBias : public BaseVertex<3, NavState>
#endif
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
#else
    VertexNavStateBias() : BaseVertex<3, NavState>(){}
#endif
...
#else
class EdgeNavStateBias : public BaseBinaryEdge<3, IMUPreintegrator, VertexNavStateBias, VertexNavStateBias>
#endif
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
#else
    EdgeNavStateBias() : BaseBinaryEdge<3, IMUPreintegrator, VertexNavStateBias, VertexNavStateBias>() {}
#endif
...
#else
class EdgeNavStatePriorPVRBias : public BaseBinaryEdge<12, NavState, VertexNavStatePVR, VertexNavStateBias>
#endif
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
#else
    EdgeNavStatePriorPVRBias() : BaseBinaryEdge<12, NavState, VertexNavStatePVR, VertexNavStateBias>() {}
#endif
